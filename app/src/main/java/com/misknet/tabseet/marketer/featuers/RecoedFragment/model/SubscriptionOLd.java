...
import com.misknet.tabseet.marketer.featuers.HomeFragment.model.Group;
...
public class SubscriptionOLd {
    ...
    @SerializedName("city")
    @Expose
    private OldCity city;
    @SerializedName("building_cat")
    @Expose
    private OldBuildingCat buildingCat;
    @SerializedName("building_type")
    @Expose
    private OldBuildingType buildingType;
    ...
    public OldCity getCity() {
        return city;
    }

    public void setCity(OldCity city) {
        this.city = city;
    }

    public OldBuildingCat getBuildingCat() {
        return buildingCat;
    }

    public void setBuildingCat(OldBuildingCat buildingCat) {
        this.buildingCat = buildingCat;
    }

    public OldBuildingType getBuildingType() {
        return buildingType;
    }

    public void setBuildingType(OldBuildingType buildingType) {
